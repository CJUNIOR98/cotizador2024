...
define('SITE_NAME'               , 'CotizadorApp');    // Nombre del sitio
...
define('PHPMAILER_DEBUG'         , true);               // Solo activar si es necesario el log verboso para debug
...
define('LDB_NAME'                , 'db_cotizador2024');
